...
class TestClassWeatherUI:
    ...
    def test_city_weather(self):
        self.driver.get("http://localhost:5000/")
        self.driver.find_element(By.XPATH, "//input[@class='input']").send_keys('Washington')
        self.driver.find_element(By.XPATH, "//button[@class='button is-info']").click()
        assert self.driver.find_element(By.XPATH, "//span[contains(text(),'Washington, ')]")

    @pytest.mark.ui
    def test_empty_city_weather(self):
        self.driver.get("http://localhost:5000/")
        self.driver.find_element(By.XPATH, "//button[@class='button is-info']").click()
        assert self.driver.find_element(By.XPATH, "//h1[contains(text(),'City is Required')]")
